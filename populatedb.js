...
console.log('This script populates some test items and sellers to your database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0.lz91hw2.mongodb.net/?retryWrites=true&w=majority');
...
async function establishFakeStoreData() {
...
function sellerCreate(first_name, last_name, joined_date, cb) {
    const sellerdetail = {
...
function createSellers(cb) {
    sellerCreate('Fake', 'Store', new Date(), cb);
}
...
function createItems(cb) {
    ...
    async.series(itemFunctionsArray, cb);
}
